...
For local CLI / editor integration, there is also the [`@kumikijs/mcp`](https://github.com/kumikijs/Kumiki/tree/main/packages/mcp) server that runs over stdio.
