...
[`features/README.ja.md`](./features/README.ja.md) はトピック別に選んだ案内である。ディレクトリにある全ファイルの一覧は [spec インデックス](../../docs/ja/spec/index.md)にあり、こちらはディスク上のファイルと完全に一致することを CI が保証する。
